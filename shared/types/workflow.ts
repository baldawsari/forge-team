...
// ============================================================================
// YAML Workflow Definition Types (loaded from workflows/*.yaml)
// ============================================================================
...
// ============================================================================
// Runtime Workflow Instance Types
// ============================================================================
...
export interface WorkflowHistoryEntry {
  ...
  type: 'phase_started' | 'phase_completed' | 'phase_failed'
    ...
    | 'checkpoint_created' | 'workflow_paused' | 'workflow_resumed'
...
export type WorkflowEventType =
  ...
  | 'workflow.step.approval_requested'
  | 'workflow.step.approval_resolved'
