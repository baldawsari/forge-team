...
export const mockDelegations: DelegationEntry[] = [
  {
    ...
    proofChain: [
      ...
      "Architect capabilities verified: architecture, system-design",
  ...
  },
  {
    ...
    proofChain: [
      "Sub-task delegated by Architect under BMad Master authorization",
      "Backend Developer capabilities verified: backend, messaging, rabbitmq",
  ...
  },
  {
    ...
    proofChain: [
      "Task assigned by BMad Master with authority level: HIGH",
      "QA / Test Architect capabilities verified: testing, integration, e2e",
  ...
  },
  {
    ...
    proofChain: [
      "Task assigned by BMad Master with authority level: HIGH",
      "DevOps Engineer capabilities verified: devops, ci-cd, docker, k8s",
  ...
  },
  {
    ...
    proofChain: [
      ...
      "Backend Developer capabilities verified: backend, security-fixes",
  ...
  {
    id: "del-6",
    delegator: "Product Owner",
    delegatee: "Business Analyst",
    ...
    timestamp: "2026-02-26T08:00:00Z",
    proofChain: [
      "Requirements task delegated by Product Owner",
      "Business Analyst capabilities verified: analysis, brd, requirements",
...
export const mockMemoryData: AgentMemoryData[] = [
  ...
  { agentId: "product-owner", agentName: "Product Owner", agentNameAr: "مالك المنتج", shortTermTokens: 18000, shortTermLastUpdated: 8, longTermEntries: 124, longTermTokens: 310000 },
  { agentId: "business-analyst", agentName: "Business Analyst", agentNameAr: "محلل الأعمال", shortTermTokens: 12000, shortTermLastUpdated: 25, longTermEntries: 89, longTermTokens: 245000 },
  { agentId: "scrum-master", agentName: "Scrum Master", agentNameAr: "سكرم ماستر", shortTermTokens: 8500, shortTermLastUpdated: 5, longTermEntries: 67, longTermTokens: 156000 },
  { agentId: "architect", agentName: "Architect", agentNameAr: "المعماري", shortTermTokens: 45000, shortTermLastUpdated: 1, longTermEntries: 210, longTermTokens: 580000 },
  { agentId: "ux-designer", agentName: "UX/UI Designer", agentNameAr: "مصمم UX/UI", shortTermTokens: 14000, shortTermLastUpdated: 18, longTermEntries: 95, longTermTokens: 198000 },
  { agentId: "frontend-dev", agentName: "Frontend Developer", agentNameAr: "مطور الواجهة", shortTermTokens: 28000, shortTermLastUpdated: 3, longTermEntries: 156, longTermTokens: 390000 },
  { agentId: "backend-dev", agentName: "Backend Developer", agentNameAr: "مطور الخلفية", shortTermTokens: 38000, shortTermLastUpdated: 4, longTermEntries: 178, longTermTokens: 520000 },
  { agentId: "qa-architect", agentName: "QA / Test Architect", agentNameAr: "مهندس الجودة", shortTermTokens: 22000, shortTermLastUpdated: 6, longTermEntries: 134, longTermTokens: 345000 },
  { agentId: "devops-engineer", agentName: "DevOps Engineer", agentNameAr: "مهندس DevOps", shortTermTokens: 15000, shortTermLastUpdated: 12, longTermEntries: 78, longTermTokens: 210000 },
  { agentId: "security-specialist", agentName: "Security & Compliance", agentNameAr: "الأمن والامتثال", shortTermTokens: 35000, shortTermLastUpdated: 7, longTermEntries: 145, longTermTokens: 410000 },
  { agentId: "tech-writer", agentName: "Technical Writer", agentNameAr: "الكاتب التقني", shortTermTokens: 20000, shortTermLastUpdated: 15, longTermEntries: 112, longTermTokens: 280000 },
];
