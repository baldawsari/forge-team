...
export type DelegationStatus = 'pending' | 'accepted' | 'rejected' | 'in-progress' | 'completed' | 'failed' | 'revoked' | 'escalated';
...
export type DelegationAuditAction = 'request.created' | 'request.accepted' | 'request.rejected' | 'token.issued' | 'token.revoked' | 'checkpoint.reached' | 'checkpoint.failed' | 'work.submitted' | 'verification.started' | 'verification.passed' | 'verification.failed' | 'escalation.triggered' | 'trust.updated';
//# sourceMappingURL=viadp.d.ts.map