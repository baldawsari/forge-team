...
export type AgentId = 'bmad-master' | 'product-owner' | 'business-analyst' | 'scrum-master' | 'architect' | 'ux-designer' | 'frontend-dev' | 'backend-dev' | 'qa-architect' | 'devops-engineer' | 'security-specialist' | 'tech-writer';
/** Current operational status of an agent */
export type AgentStatus = 'idle' | 'working' | 'reviewing' | 'blocked' | 'offline' | 'error';
...
export type AgentMessageType = 'task.assign' | 'task.complete' | 'task.fail' | 'task.progress' | 'delegation.request' | 'delegation.response' | 'delegation.revoke' | 'agent.status' | 'agent.heartbeat' | 'chat.message' | 'chat.response' | 'system.notification' | 'system.error' | 'workflow.step' | 'workflow.complete' | 'review.request' | 'review.response';
