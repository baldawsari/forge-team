...
// Agent Manager
// ---------------------------------------------------------------------------
class AgentManager extends eventemitter3_1.EventEmitter {
    configs = new Map();
    states = new Map();
     ...
     */
    assignTask(agentId, taskId, sessionId) {
        const state = this.states.get(agentId);
     ...
     */
    findAgentForCapability(capability, excludeAgents) {
        const candidates = [];
